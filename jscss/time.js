function showTime() {
	...
	var startDate = new Date('2020/10/29 20:59:00');
	...
	if (seconds < 10)
	seconds = "0" + seconds;
	var currentTimeString = "<br><br>Dear Twotwo~:<br>"
		...
		+	"<c style=\"color: #FFC000; text-shadow:2px 3px 3px #0ff; font-family:Microsoft YaHei; font-size:20px\" >-------- LL </c>";
